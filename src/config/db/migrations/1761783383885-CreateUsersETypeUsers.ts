...
export class CreateUsersETypeUsers1761783383885 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "type_users" ("id" SERIAL NOT NULL, "description" character varying(7) NOT NULL, CONSTRAINT "UQ_e98e791334cb724337a820725b4" UNIQUE ("description"), CONSTRAINT "PK_d655bb42bef0f87f7db0e59270d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
